...
function Product({ scrollRef }) {
  ...
  return (
    <RoundedBox ref={mesh} args={[1.4, 3.0, 0.36]} radius={0.1} smoothness={8}>
...
function Scene({ scrollRef }) {
  return (
    <Canvas camera={{ position: [0, 0, 5], fov: 42 }} gl={{ antialias: true, alpha: true }}>
      ...
      <directionalLight position={[-4, -2, -3]} intensity={2} color="#a78bfa" />
      <pointLight position={[0, 4, 3]} intensity={8} color="#e9d5ff" distance={10} />
